...
if st.sidebar.selectbox('Selecione a Operadora', index=0, options=operadoras) == operadoras[0]:
    ...
    st.write("Operadora Bradesco Saúde")
    ...
    st.write("Operadora Amil Assistencia Médica")
    ...
    st.write("Operadora Sul América")
    ...
    st.write("Operadora Unimed Nacional")
    ...
    st.write("Operadora Unimed Belo Horizonte")
    ...
    st.write("Operadora Unimed Seguros Saúde")
    ...
    st.write("Operadora Unimed Porto Alegre")
    ...
    st.write("Operadora Unimed Curitiba")
    ...
    st.write("Operadora Caixa de Assistencia")
    ...
    st.write("Operadora NotreDame Minas Gerais")
    ...
    st.write("Operadora Prevent Senior")
else:
    df = pd.read_csv("dados Selecionados/dados_unimedcampinas.csv", sep=",")
    st.write("Operadora Unimed Campinas")
